        ...
        data.usuarios.forEach((usuarios, index) => {
            content += `
                <tr>
                    ...
                    <td class='text-end'><a href="/configuracion/staff/edit/${usuarios.id}/" type="button" class="btn btn-primary">Edit</a> <a href="/configuracion/staff/edit/password/${usuarios.id}/" type="button" class="btn btn-primary">Update password</a> <button type="button" onClick="delete_user(${usuarios.id})" data-id="${usuarios.id}" href="/admin/auth/user/${usuarios.id}/delete/" type="button" class="btn btn-danger eliminar-registro">Delete</button></td>
                </tr>`;
        });
