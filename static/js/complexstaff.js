        ...
        data.usuarios.forEach((usuarios, index) => {
            content += `
                <tr>
                    ...
                    <td class='text-end'><a href="/configuracion/staff/edit/${usuarios.id}/" type="button" class="btn btn-dark btn-sm">Edit</a> <a href="/configuracion/staff/edit/password/${usuarios.id}/" type="button" class="btn btn-dark btn-sm">Update password</a> <button type="button" onClick="delete_user(${usuarios.id})" data-id="${usuarios.id}" href="/admin/auth/user/${usuarios.id}/delete/" type="button" class="btn btn-danger btn-sm eliminar-registro">Delete</button></td>
                </tr>`;
        });
